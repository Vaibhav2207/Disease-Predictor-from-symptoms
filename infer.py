...
#     lst = []
#     x = int(input("Enter no of Symptoms"))
#     for i in range(x):
#         str1 = str(input("Enter symptoms"))
#         lst.append(str1)
...
def main():
    ...
    if predict_button and symptom_input:
        # Splitting user input into a list of symptoms
        user_symptoms = [s.strip() for s in symptom_input.split(',')]
        
        # Setting selected symptoms to 1
